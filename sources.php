...
<body>
    ...
    <div id="formAjoutEquipe">
        <form id="form" method="POST" onsubmit="erasePopup('erreurPopup'),erasePopup('validationPopup')" enctype="multipart/form-data">

            <div class="miseEnForme" style="display: grid; place-items: center; width: 70%; align-self: center; justify-self: center;">
                <h1 style="margin-top: 0px;">Application web réalisée par : </h1>
                    <ul style="margin-bottom: 10px;">
                        <li>Mathieu ANTUNES</li>
                        <li>Paul THOUVEREY</li>
                        <li>Matthis VAN DE VYVER</li>
                        <li>Iannis FERREIRA</li>
                    </ul>
                <p style="margin-bottom: 100px;">Dans le cadre d'un projet SAE a l'université Toulouse III Paul Sabatier, département Informatique. 2022/2023</p>
                
                <h3 style="position: relative; font-size: 1.3em; margin-bottom: 30px; left: 0px;">Icones utilisés : </h3>
                ...
                <div>
                    <ul>
                        ...
                        <a href="https://www.flaticon.com/fr/icones-gratuites/la-fleche" title="la flèche icônes">La flèche icônes créées par Catalin Fertu - Flaticon</a></li>
                    </ul>
                </div>
